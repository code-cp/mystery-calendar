...
class MovieInfo():
    ...
    def get_describe(self):
        ...
        try:
            ...
            movie_type = genre_pattern.findall(movie_info)

            date_pattern = re.compile(r'<span property="v:initialReleaseDate" content="(.*?)">')
            releasedate = date_pattern.findall(movie_info)
